...
public class JerseyClient {
	public void getArticleDetails() {
		...
		WebTarget base = client.target("http://localhost:9191/SpringWebservice/article");
	...
	public void getArticleById(int articleId) {
		Client client = ClientBuilder.newClient();
		WebTarget base = client.target("http://localhost:9191/SpringWebservice/article");
		WebTarget articleById = base.path("getArticleById/{id}").resolveTemplate("id", articleId);
	...
	public void addArticle(Article article) {
		Client client = ClientBuilder.newClient();
		WebTarget base = client.target("http://localhost:9191/SpringWebservice/article");
		WebTarget add = base.path("addArticle");
	...
	public void updateArticle(Article article) {
		Client client = ClientBuilder.newClient();
		WebTarget base = client.target("http://localhost:9191/SpringWebservice/article");
		WebTarget update = base.path("updateArticle");
	...
	public void deleteArticle(int articleId) {
		Client client = ClientBuilder.newClient();
		WebTarget base = client.target("http://localhost:9191/SpringWebservice/article");
		WebTarget deleteById = base.path("deleteArticleById/{id}").resolveTemplate("id", articleId);
	...
	public static void main(String[] args) {
	   ...
	   //jerseyClient.getArticleDetails();
		...
		article.setTitle("Python Machine");
		...
		jerseyClient.deleteArticle(106);
	}
}
